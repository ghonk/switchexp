...
instructiontext=[
    ...
    #classify val
    ["validation",
    "    Now we are going to check how well you are learning the \n\
    categories.  You will be shown more leaf examples and your job is to\n\
    select the category label that matches the leaf. You will not\n\
    receive feedback on your responses.\n\n\
    Try to be as accurate as you can! If you do well, you will\n\
    finish the experiment faster.\n\n\
    Press the spacebar when you are ready to begin."],
